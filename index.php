    ...
    <div class="dj-content dj-padding" style="max-width:1564px">
        ...
        <div class="dj-padding-32 dj-left" style="margin-top:170px;margin-left: 3rem;">
            ...
            <a href="register.php"><button type="button"
                    class="dj-button dj-round-large dj-orange dj-margin-top-32">Sign Up Now</button></a>
        </div>
...
border-radius: 5px;">
            ...
            <div class="dj-padding dj-half" width="60%">
                ...
                <form action="" method="post" class="dj-margin-top">
                    ...
                    <button name="button"
                        class="dj-margin-top-32 dj-button dj-orange dj-round-large">Submit Here</button>
                </form>
            ...
            <div class="dj-padding dj-row-padding">
                <div class="dj-third">
                    ...
                    <div class="dj-padding dj-margin-top dj-margin-left dj-margin-right">
                        ...
                        <p style="margin-top: 3rem;font-size: 12.5px;font-family: sans-serif;" class="dj-text-orange">@ Copyright 2022 reserved by <a href="index.php">OutGo</a>. All rights reserved.</p>
                    </div>
                </div>
                <div class="dj-third">
...
border-radius: 5px;">
                    <div class="dj-container dj-margin">
                        ...
                        <a href="" class="dj-hover-shadow-white dj-padding dj-round-large"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="pink" class="bi bi-instagram" viewBox="0 0 16 16">
                          ...
                          <a href="" class="dj-hover-shadow-white dj-padding dj-remove-underline dj-round-large">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="skyblue" class="bi bi-meta" viewBox="0 0 16 16">
                          ...
                          <a href="" class="dj-hover-shadow-white dj-padding dj-remove-underline dj-round-large">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#FF1A1A" class="bi bi-youtube" viewBox="0 0 16 16">
                          ...
                          <a href="" class="dj-hover-shadow-white dj-padding dj-remove-underline dj-round-large">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="lightblue" class="bi bi-linkedin" viewBox="0 0 16 16">
